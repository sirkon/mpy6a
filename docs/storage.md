...
* [Описание восстановления данных\.](#описание-восстановления-данных)
* [Описание системы хранения\.](#описание-системы-хранения)
    * [Хранение сохранённых сессий\.](#хранение-сохранённых-сессий)
    * [Хранение активных сессий\.](#хранение-активных-сессий)
    * [Смежное хранение сессий в слепках\.](#смежное-хранение-сессий-в-слепках)
    * [Операция объединения и слепки\.](#операция-объединения-и-слепки)
    * [Управление файлами\.](#управление-файлами)
    * [Замечание по поводу источников сохранённых сессий\.](#замечание-по-поводу-источников-сохранённых-сессий)
    * [Буферизация файлов для сессий с одинаковым таймаутом повтора\.](#буферизация-файлов-для-сессий-с-одинаковым-таймаутом-повтора)
    * [Выбор слепка при старте сервиса\.](#выбор-слепка-при-старте-сервиса)
* [Процедура создания слепка\.](#процедура-создания-слепка)
* [Учёт гонки повторов сессий из памяти с созданием слепка\.](#учёт-гонки-повторов-сессий-из-памяти-с-созданием-слепка)
* [Процедура слияния\.](#процедура-слияния)
* [Синхронизация файловых операций\.](#синхронизация-файловых-операций)
* [Ошибки низкого уровня при операциях с хранящимися данными\.](#ошибки-низкого-уровня-при-операциях-с-хранящимися-данными)
* [Хранение лога\.](#хранение-лога)
* [Обработка состояния для кандидата ставшего лидером\.](#обработка-состояния-для-кандидата-ставшего-лидером)
* [Наглядная схема файлов хранения данных\.](#наглядная-схема-файлов-хранения-данных)
...
## Ошибки низкого уровня при операциях с хранящимися данными.
